...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        # self.epsilon = self.epsilon_decay**self.trial
        # self.epsilon = 1.0/float(self.trial**2)
        # self.epsilon = 1.0/math.exp(self.epsilon_decay * self.trial)
        # self.epsilon = math.cos(self.epsilon_decay * self.trial)
